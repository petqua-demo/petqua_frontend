...
export default function MySellingPosting({ navigation }: any) {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <BoldText style={styles.headerText}>분양 내역</BoldText>
        </View>
        {/* 전체, 예약중, 분양완료 나누는 상단 탭.
        ...
        <View style={styles.tab}>
          ...
          >
            {(selectedCategory == Categories.sold && (
              <Text style={styles.selectedTabText}>{Categories.sold}</Text>
            )) ||
              (selectedCategory != Categories.sold && (
                <Text style={styles.tabText}>{Categories.sold}</Text>
              ))}
          </Pressable>
        </View>
        {/* 분양내역 리스트 */}
